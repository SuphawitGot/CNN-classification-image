...
(Note: tkinter and json are built into standard Python, so you don't need to install them separately).
...
3. Make Predictions
Once the model is trained and saved, you can run the result script. A file dialog window will pop up asking you to select an image. After you select one, the script will output the predicted fruit in the terminal!
